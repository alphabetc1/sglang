"""E2E: adaptive spec + Standalone V2 (overlap scheduling, inherits EAGLEWorkerV2)."""
...
print("=== Launching Standalone V2 (spec v2) adaptive server ===")
...
try:
    ...
    print("\n=== STANDALONE V2 ADAPTIVE E2E PASSED ===")

except Exception as e:
    print(f"\n=== STANDALONE V2 ADAPTIVE E2E FAILED: {e} ===")
