...
"""SWA (sliding window) token-to-KV-pool slot allocator.

Tracks window position to free out-of-window slots as the window slides.
"""
...
from sglang.srt.mem_cache.allocator.unpaged import TokenToKVPoolAllocator
