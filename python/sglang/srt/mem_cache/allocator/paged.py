...
"""Paged (page_size > 1) token-to-KV-pool slot allocator.

Allocates KV slots in page-aligned blocks; output of one request is always
page-aligned. Used with PagedAttention-style backends.
"""
