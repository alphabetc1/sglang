...
"""HiSparse slot allocators.

Two variants in this file (both are HiSparse-strategy allocators, despite
class-name prefix differences):
  - HiSparseTokenToKVPoolAllocator: HiSparse strategy on NSA-layout pool
  - DeepSeekV4HiSparseTokenToKVPoolAllocator: HiSparse strategy on DSv4-layout pool
"""
